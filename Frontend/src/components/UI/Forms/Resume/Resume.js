...
function Resume() {
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(`https://generette.onrender.com/edit/resume/${id}`)
        .then((response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    await fetch("https://generette.onrender.com/resume", {
      method: "POST",
      headers: {
  ...
  switch (index) {
    ...
    case 2:
      content = (
        <Links
          ...
          prevStep={prevStep}
          values={refs}
          increase={fieldAddHandler}
          decrease={fieldRemoveHandler}
        ></Links>
      );
      break;
    case 3:
    ...
    case 4:
      content = (
        <WorkExperience
          ...
          prevStep={prevStep}
          values={refs}
          increase={fieldArrayAddHandler}
          decrease={fieldRemoveHandler}
          increaseLink={linkIncreaseHandler}
          decreaseLink={linkDecreaseHandler}
    ...
    case 6:
      content = (
        <Achievements
          onChange={handleArrayChange}
          title="Academic Achievements and Awards"
          nextStep={nextStep}
          prevStep={prevStep}
          values={refs}
          increase={fieldArrayAddHandler}
    ...
    case 7:
      content = (
        <Skills
          ...
          prevStep={prevStep}
          values={refs}
          increase={skillFieldAddHandler}
          decrease={skillFieldRemoveHandler}
        />
      );
      break;
    case 8:
      ...
      break;
    default:
      content = <FinalPage title="Thank You!" />;
      break;
  }
